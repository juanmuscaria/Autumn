...
public class UrlResource extends AbstractFileResolvingResource {
    ...
    public UrlResource(String path) throws MalformedURLException {
        ...
        String cleanedPath = ResourceUtils.cleanPath(path);
        URI uri;
        URL url;
    ...
    private String getCleanedUrl() {
        ...
        cleanedUrl = ResourceUtils.cleanPath(originalPath);
    ...
    public String getFilename() {
        if (this.uri != null) {
            ...
            if (path != null) {
                ...
                return ResourceUtils.getFilename(this.uri.getPath());
            }
        }
        // Otherwise, process URL path
        String filename = ResourceUtils.getFilename(ResourceUtils.cleanPath(this.url.getPath()));
        try {
            return (filename != null ? URLDecoder.decode(filename, StandardCharsets.UTF_8.toString()) : null);
