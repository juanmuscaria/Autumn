...
public class ResourceBundleMessageSource extends AbstractResourceBasedMessageSource {
    ...
    @Nullable
    private ClassLoader classloader = ResourceUtils.getDefaultClassLoader();
     ...
     * <p>Default is the current thread context classloader
     */
    ...
    protected ClassLoader getBundleClassLoader() {
        return (this.bundleClassLoader != null ? this.bundleClassLoader : this.classloader);
    }
        ...
        if (getCacheMillis() >= 0) {
            ...
            try {
                ...
                if (logger.isLoggable(Level.WARNING)) {
                    logger.warning("ResourceBundle [" + basename + "] not found for MessageSource: " + ex.getMessage());
                }
    ...
    protected ResourceBundle doGetBundle(String basename, Locale locale) throws MissingResourceException {
        ...
        if (control != null) {
            try {
                ...
                if (encoding != null && logger.isLoggable(Level.INFO)) {
